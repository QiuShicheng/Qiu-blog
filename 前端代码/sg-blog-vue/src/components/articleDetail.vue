                ...
                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
                    <el-col  :span="12"   class="donate-item">
                      <div class="donate-tip">
                        <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/wx_pay.jpg'" :onerror="$store.state.errorImg" style="max-width: 200%;display: block; margin: 0 auto;"/>
                        <span style="text-align: center; margin: 0 auto; display: block;">微信扫一扫，请我喝杯咖啡</span>
                      </div>
                    </el-col>
<!--                    <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
